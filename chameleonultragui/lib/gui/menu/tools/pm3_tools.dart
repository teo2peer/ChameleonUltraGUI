    ...
    _Pm3Category(
      ...
      tools: [
        ...
        _Pm3Tool(
          ...
          Icons.send,
          (context) => _push(context, const ApduTerminalPage()),
        ),
        _Pm3Tool(
          'hf 14a sniff',
          'Capture the reader/card exchange while the device emulates a card.',
          Icons.radar,
          (context) => _dialog(context, const HfSniffingMenu()),
        ),
      ],
    ),
    _Pm3Category(
      ...
      tools: [
        ...
        _Pm3Tool(
          ...
          Icons.memory,
          (context) =>
              _push(context, const NestedPage(variant: NestedVariant.hard)),
        ),
        _Pm3Tool(
          'hf mf value',
          'Increment, decrement, restore, and transfer a value block.',
          Icons.exposure,
          (context) => _dialog(context, const ValueBlockMenu()),
        ),
      ],
    ),
    _Pm3Category(
      ...
      tools: [
        ...
        _Pm3Tool(
          ...
          Icons.timeline,
          (context) => _dialog(context, const LfSniffingMenu()),
        ),
        _Pm3Tool(
          'lf ioProx codec',
    ...
    _Pm3Category(
      ...
      tools: [
        ...
        _Pm3Tool(
          ...
          Icons.numbers,
          (context) => _dialog(context, const WiegandMenu()),
          deviceRequired: false,
        ),
      ],
    ),
