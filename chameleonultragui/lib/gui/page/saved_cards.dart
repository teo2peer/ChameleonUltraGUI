        ...
        children: [
          Expanded(
            child: Card(
              child: Column(
                children: [
                  sectionHeader(localizations.cards, [
                    IconButton(
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                                  ...
                                  onPressed: importCard = () async {
                                    ...
                                    if (result != null) {
                                      ...
                                      try {
                                        ...
                                        selectedType = getTagTypeByDumpSize(
                                          contents.length,
                                        );
                              ...
                              Expanded(
                                child: ElevatedButton(
                                  onPressed: createCard = () async {
                                    showDialog(
                                      context: context,
                                      builder: (context) =>
                                          const CardCreateMenu(),
                                    );
                                  },
                                  style: customCardButtonStyle(appState),
                      ...
                      child: AlignedGridView.count(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          return ElementButton(
                            ...
                            secondLine: chameleonCardToString(
                              tag,
                              localizations,
                            ),
                            itemIndex: index,
          ...
          Expanded(
            child: Card(
              child: Column(
                children: [
                  sectionHeader(localizations.dictionaries, [
                    IconButton(
                                ...
                                onPressed: () async {
                                  if (appState.sharedPreferencesProvider
                                    ...
                                    var confirm = await showDialog(
                                      ...
                                      builder: (BuildContext context) {
                                        return ConfirmDeletionMenu(
                                          thingBeingDeleted: dictionary.name,
                                        );
                                      },
                                    );
