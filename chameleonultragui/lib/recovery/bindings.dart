...
class Recovery {
  ...
  void recovery_free(
    ...
    return _recovery_free(
      pointer,
    );
  }

  late final _recovery_freePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
          'recovery_free');
  late final _recovery_free =
      _recovery_freePtr.asFunction<void Function(ffi.Pointer<ffi.Void>)>();
  ...
  late final _mfkey64Ptr =
      _lookup<ffi.NativeFunction<ffi.Uint64 Function(ffi.Pointer<Mfkey64>)>>(
          'mfkey64');
  late final _mfkey64 =
      _mfkey64Ptr.asFunction<int Function(ffi.Pointer<Mfkey64>)>();
...
final class Mfkey64 extends ffi.Struct {
  /// serial number
  @ffi.Uint32()
  external int uid;
  ...
  /// encrypted tag response / next nt
  @ffi.Uint32()
  external int at_enc;
}
